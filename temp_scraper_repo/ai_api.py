...
import openai
from enhanced_ai_assistant import get_ai_assistant
...
@login_required
def ai_assistant():
    """Enhanced AI assistant with UI control capabilities"""
    try:
        ...
        user_info = {
            ...
            'subscription_plan': getattr(current_user, 'subscription_plan', 'trial'),
        ...
        app_context = {
            ...
            'assets_count': context.get('assets_count', 0)
        }

        # Get AI assistant and process message
        ai_assistant = get_ai_assistant()
        response = ai_assistant.process_message(message, app_context, user_info)
