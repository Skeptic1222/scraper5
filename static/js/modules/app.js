...
class MediaScraperApp {
    ...
    initializeModules() {
        ...
        if (window.EnhancedAssetManager) {
            ...
            console.log('✅ EnhancedAssetManager initialized');
        } else {
            console.warn('⚠️ EnhancedAssetManager class not found');
        }
        ...
        if (window.SearchManager) {
            ...
            console.warn('⚠️ SearchManager class not found');
        }
    ...
    async handleSearchSubmit(e) {
        ...
        try {
            ...
            const searchData = {
                query: SecurityUtils.sanitizeSearchInput(formData.get('search-query')),
                searchType: formData.get('search-type'),
                maxItems: SecurityUtils.validateNumber(formData.get('max-items'), 5, 100),
                safeSearch: formData.has('safe-search-toggle')
            };
    ...
    async loadSources() {
        try {
            ...
            this.showWarning('Some content sources may not be available');
        }
    }
