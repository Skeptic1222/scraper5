...
class User(UserMixin, db.Model):
    ...
    def is_admin(self):
        ...
        if self.email == 'sop1973@gmail.com':
            return True
...
def init_db():
    ...
    if not Role.query.filter_by(name='admin').first():
        admin_role = Role(
            ...
            permissions=json.dumps([
                ...
                'start_jobs', 'delete_assets', 'view_all_jobs',
                'view_all_assets'
            ])
        )
    ...
    if not Role.query.filter_by(name='user').first():
        user_role = Role(
            ...
            permissions=json.dumps([
                'start_jobs', 'delete_own_assets', 'view_own_jobs',
                'view_own_assets'
            ])
        )
    ...
    admin_user = User.query.filter_by(email='sop1973@gmail.com').first()
